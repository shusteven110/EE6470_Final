...
SobelFilter::SobelFilter(sc_module_name name) : sc_module(name) 
    ...
    ,SobelFilter_gen_busy_r_4_14_i_rgb_gen_busy_i_rgb_m_data_is_invalid_next("SobelFilter_gen_busy_r_4_14_i_rgb_gen_busy_i_rgb_m_data_is_invalid_next")
    ,SobelFilter_gen_busy_r_4_14_gdiv("SobelFilter_gen_busy_r_4_14_gdiv")
    ,SobelFilter_gen_busy_r_4_14_gnew_req("SobelFilter_gen_busy_r_4_14_gnew_req")
    ...
    ,SobelFilter_Add2Mul2s32s32s32_4_10_out1("SobelFilter_Add2Mul2s32s32s32_4_10_out1")
    ,s_reg_5("s_reg_5")
    ...
    ,s_reg_10("s_reg_10")
    ,SobelFilter_gen_busy_r_4_14_out1("SobelFilter_gen_busy_r_4_14_out1")
    ,SobelFilter_And_1Ux1U_1U_4_12_out1("SobelFilter_And_1Ux1U_1U_4_12_out1")
    ,SobelFilter_Not_1U_1U_1_3_out1("SobelFilter_Not_1U_1U_1_3_out1")
    ,o_avg_m_req_m_trig_req("o_avg_m_req_m_trig_req")
    ,SobelFilter_Gti0s6_4_9_out1("SobelFilter_Gti0s6_4_9_out1")
    ...
    ,shift_reg_out1("shift_reg_out1")
{
  ...
  sensitive << ( SobelFilter_gen_busy_r_4_14_out1 );
  sensitive << ( SobelFilter_And_1Ux1U_1U_4_12_out1 );
  ...
  sensitive << ( SobelFilter_Gti0s6_4_9_out1 );
  ...
  SC_METHOD(SobelFilter_Gti0s6_4_9);
  sensitive << ( s_reg_10 );
  ...
  SC_METHOD(SobelFilter_Add2Mul2s32s32s32_4_10);
  ...
  SC_METHOD(SobelFilter_gen_busy_r_4_14_p7);
  sensitive << ( 
  SobelFilter_gen_busy_r_4_14_i_rgb_gen_busy_i_rgb_m_data_is_invalid_next );
  sensitive << ( SobelFilter_gen_busy_r_4_14_gdiv );
  sensitive << ( SobelFilter_gen_busy_r_4_14_gnew_req );

  SC_METHOD(SobelFilter_gen_busy_r_4_14_p6);
  sensitive << ( SobelFilter_gen_busy_r_4_14_gdiv );

  SC_METHOD(SobelFilter_gen_busy_r_4_14_p5);
  sensitive << ( SobelFilter_gen_busy_r_4_14_gnew_req );
  sensitive << ( i_rgb_vld );

  SC_METHOD(SobelFilter_gen_busy_r_4_14_p4);
  sensitive << ( i_rgb_vld );
  ...
  SC_METHOD(SobelFilter_And_1Ux1U_1U_4_12);
  sensitive << ( o_avg_vld );
...
void SobelFilter::drive_i_rgb_m_busy_req_0(){
  if ( (i_rst.read() == 0ULL) ) {
    ...
    default:
      ...
      case 4ULL: 
        if ( SobelFilter_Gti0s6_4_9_out1.read() );
        else {
...
void SobelFilter::drive_stall0(){
  ...
  default:
    ...
    break;
  case 5ULL: 
    stall0 = (sc_uint<1> )SobelFilter_gen_busy_r_4_14_out1.read();
    break;
  case 8ULL: 
    stall0 = SobelFilter_And_1Ux1U_1U_4_12_out1.read();
    break;
  }
}
  ...
  if ( (i_rst.read() == 0ULL) ) {
    ...
    default:
      ...
      case 1ULL: 
        ...
        default:
          s_reg_10 = (sc_uint<6> ) (SobelFilter_Add2i1u5_4_6_out1.read());
          break;
        case 28ULL: 
          s_reg_10 = 27ULL;
          break;
        ...
        break;
      case 3ULL: 
        s_reg_10 = (sc_uint<6> ) (SobelFilter_Sub_5Ux1U_6S_4_7_out1.read());
        break;
      case 8ULL: 
        s_reg_10 = 27ULL;
        break;
...
void SobelFilter::drive_s_reg_5(){
  if ( (i_rst.read() == 0ULL) ) {
    ...
    default:
      switch( (sc_uint<4>)(global_state.read()) ) {
      case 4ULL: 
        s_reg_5 = (sc_uint<32> ) (SobelFilter_Add2Mul2s32s32s32_4_10_out1.read()
                  );
        break;
      case 7ULL: 
        s_reg_5 = (sc_uint<32> ) (SobelFilter_Add_32Ux32U_32U_4_11_out1.read());
        break;
      }
      break;
    }
...
void SobelFilter::SobelFilter_Add2i1u5_4_6(){
  SobelFilter_Add2i1u5_4_6_out1 = (/*cliff*/sc_uint<32>)((sc_uint<5> )s_reg_10
                                  .read() + 1ULL);
}
...
void SobelFilter::drive_shift_reg_in1(){
  ...
  default:
    shift_reg_in1 = (sc_uint<5> )s_reg_10.read();
    break;
  case 1ULL: 
    switch( (sc_uint<6>)(SobelFilter_Add2i1u5_4_6_out1.read()) ) {
    default:
...
void SobelFilter::drive_SobelFilter_Sub_5Ux1U_6S_4_7_in2(){
  if ( gs_ctrl_do_filter_h18.read() ) {
    SobelFilter_Sub_5Ux1U_6S_4_7_in2 = (sc_uint<5> )s_reg_10.read();
  } else {
...
void SobelFilter::SobelFilter_Gti0s6_4_9(){
  SobelFilter_Gti0s6_4_9_out1 = (/*imp*/sc_uint<1>)((sc_int<6> )s_reg_10.read()
                                 > (sc_int<2> )0LL);
}
void SobelFilter::drive_filter_coeffs_in1(){
  filter_coeffs_in1 = (sc_uint<5> )s_reg_10.read();
}
// resource: mux_1bx2i2c
...
void SobelFilter::SobelFilter_Add2Mul2s32s32s32_4_10(){
  SobelFilter_Add2Mul2s32s32s32_4_10_out1 = (/*cliff*/sc_int<32>)((sc_int<32> )
                                            s_reg_5.read() + 
                                            (/*cliff*/sc_int<32>)(sc_int<32> )
                                            shift_reg_out1.read() * (sc_int<32> 
                                            )filter_coeffs_out1.read());
}
void SobelFilter::drive_SobelFilter_Add_32Ux32U_32U_4_11_in2(){
  SobelFilter_Add_32Ux32U_32U_4_11_in2 = ( (sc_uint<32> )(sc_bv<32>)((sc_bv<29>)
                                         ((sc_int<29> )shift_reg_out1.read()), 
                                         (sc_bv<3>)(0ULL)) );
}
...
void SobelFilter::drive_i_rgb_busy(){
  i_rgb_busy = (sc_uint<1> ) (((/*imp*/sc_uint<1> ) 
               SobelFilter_gen_busy_r_4_14_out1.read().range(2,2)));
}
// resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_14
void SobelFilter::SobelFilter_gen_busy_r_4_14_p7(){
  SobelFilter_gen_busy_r_4_14_out1 = (sc_uint<3> ) (( (sc_biguint<3> )(sc_bv<3>)
                                     ((sc_bv<1>)(
                                     SobelFilter_gen_busy_r_4_14_gnew_req.read()
                                     ), 
                                     (sc_bv<2>)(( (sc_biguint<2> )(sc_bv<2>)(
                                     (sc_bv<1>)(SobelFilter_gen_busy_r_4_14_gdiv
                                     .read()), 
                                     (sc_bv<1>)(SobelFilter_gen_busy_r_4_14_i_rgb_gen_busy_i_rgb_m_data_is_invalid_next
                                     .read())) ))) ));
}
// resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_14
void SobelFilter::SobelFilter_gen_busy_r_4_14_p6(){
  SobelFilter_gen_busy_r_4_14_i_rgb_gen_busy_i_rgb_m_data_is_invalid_next = ~(sc_uint<1>)SobelFilter_gen_busy_r_4_14_gdiv.read()
  ;
}
// resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_14
void SobelFilter::SobelFilter_gen_busy_r_4_14_p5(){
  SobelFilter_gen_busy_r_4_14_gdiv = (sc_uint<1> ) ((sc_uint<1> )i_rgb_vld
                                     .read() & !
                                     SobelFilter_gen_busy_r_4_14_gnew_req.read()
                                     );
}
// resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_14
void SobelFilter::SobelFilter_gen_busy_r_4_14_p4(){
  SobelFilter_gen_busy_r_4_14_gnew_req = (sc_uint<1> ) ((sc_uint<1> )
...
void SobelFilter::drive_o_avg_m_unacked_req(){
  if ( (i_rst.read() == 0ULL) ) {
    ...
    o_avg_m_unacked_req = (sc_uint<1> ) (SobelFilter_And_1Ux1U_1U_4_12_out1
                          .read());
  }
}
// resource: SobelFilter_And_1Ux1U_1U_4  instance: SobelFilter_And_1Ux1U_1U_4_12
void SobelFilter::SobelFilter_And_1Ux1U_1U_4_12(){
  SobelFilter_And_1Ux1U_1U_4_12_out1 = (sc_uint<1> ) (o_avg_busy.read() & 
                                       o_avg_vld.read());
}
