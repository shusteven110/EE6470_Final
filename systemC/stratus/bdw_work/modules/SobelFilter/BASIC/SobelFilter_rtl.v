...
module SobelFilter( i_clk, i_rst, i_rgb_busy, i_rgb_vld, i_rgb_data, o_avg_busy, o_avg_vld, o_avg_data );
    ...
    wire SobelFilter_gen_busy_r_4_16_i_rgb_gen_busy_i_rgb_m_data_is_invalid_next;
    reg[3:0] global_state_next;
    wire[31:0] SobelFilter_Mul_32Ux32U_32U_4_10_out1;
    reg[31:0] SobelFilter_Mul_32Ux32U_32U_4_10_in1;
    reg gs_ctrl_do_filter_h80;
    ...
    wire SobelFilter_GreaterThan_6Sx2S_1U_4_9_out1;
              ...
              default: 
                begin
                  case (global_state) 
                    4'd04: 
                      begin
                        if (SobelFilter_GreaterThan_6Sx2S_1U_4_9_out1) 
                          begin
                          end 
                        else 
                          begin
                    ...
                    4'd01: 
                      begin
                        case (SobelFilter_Add_5Ux1U_6U_4_6_out1) 
                          ...
                          default: 
                            begin
                              s_reg_9 <= SobelFilter_Add_5Ux1U_6U_4_6_out1;
                            end
                        endcase
                      end
                    4'd03: 
                      begin
                        s_reg_9 <= SobelFilter_Sub_5Ux1U_6S_4_7_out1;
                      end
                    4'd08: 
                      begin
                        s_reg_9 <= 6'd27;
    ...
    assign SobelFilter_Add_5Ux1U_6U_4_6_out1 = {1'b0, s_reg_9[4:0]} + 6'd01;
    
    // resource: mux_5bx4i1c
    always @(s_reg_9[4:0] or SobelFilter_Add_5Ux1U_6U_4_6_out1 or SobelFilter_Sub_5Ux1U_6S_4_7_out1[4:0] or gs_ctrl_do_filter_h172)
    ...
    // resource: mux_1bx2i2c
    always @(stall0 or SobelFilter_GreaterThan_6Sx2S_1U_4_9_out1 or gs_ctrl_do_filter_h17f)
    ...
    // resource: mux_1bx2i2c
    always @(stall0 or SobelFilter_Add_5Ux1U_6U_4_6_out1 or gs_ctrl_do_filter_h27)
    ...
    always @(s_reg_9[4:0] or gs_ctrl_do_filter_h18)
      begin : drive_SobelFilter_Sub_5Ux1U_6S_4_7_in2
        if (gs_ctrl_do_filter_h18) 
          begin
            SobelFilter_Sub_5Ux1U_6S_4_7_in2 = s_reg_9[4:0];
          end 
        else 
          begin
    ...
    assign SobelFilter_GreaterThan_6Sx2S_1U_4_9_out1 = s_reg_9[5] ^ s_reg_9 > 6'd00;
    
    // instance: drive_filter_coeffs_in1
    assign filter_coeffs_in1 = s_reg_9[4:0];
    ...
    // resource: mux_32bx2i1c
    always @(filter_coeffs_out1 or gs_ctrl_do_filter_h80)
      begin : drive_SobelFilter_Mul_32Ux32U_32U_4_10_in1
        if (gs_ctrl_do_filter_h80) 
          begin
            SobelFilter_Mul_32Ux32U_32U_4_10_in1 = 32'd0000000009;
          end 
        else 
          begin
            SobelFilter_Mul_32Ux32U_32U_4_10_in1 = filter_coeffs_out1;
          end
      end
    
    // resource: SobelFilter_Mul_32Ux32U_32U_4  instance: SobelFilter_Mul_32Ux32U_32U_4_10
    assign SobelFilter_Mul_32Ux32U_32U_4_10_out1 = shift_reg_out1 * SobelFilter_Mul_32Ux32U_32U_4_10_in1;
    
    // resource: SobelFilter_Add_32Ux32U_32U_4  instance: SobelFilter_Add_32Ux32U_32U_4_11
    assign SobelFilter_Add_32Ux32U_32U_4_11_out1 = SobelFilter_Mul_32Ux32U_32U_4_10_out1 + o_avg_data;
    ...
    always @(SobelFilter_Add_5Ux1U_6U_4_6_out1 or SobelFilter_GreaterThan_6Sx2S_1U_4_9_out1 or global_state)
    ...
    // resource: regr_en_sc_1
    always @(posedge i_clk)
      begin : drive_gs_ctrl_do_filter_h80
        if (i_rst == 1'b0) 
          begin
            gs_ctrl_do_filter_h80 <= 1'b0;
          end 
        else 
          begin
            case (stall0) 
    ...
    // resource: SobelFilter_gen_busy_r_4  instance: SobelFilter_gen_busy_r_4_16 (4 concurrent statements)
      assign SobelFilter_gen_busy_r_4_16_out1 = {SobelFilter_gen_busy_r_4_16_gnew_req, {SobelFilter_gen_busy_r_4_16_gdiv, SobelFilter_gen_busy_r_4_16_i_rgb_gen_busy_i_rgb_m_data_is_invalid_next}};
      assign SobelFilter_gen_busy_r_4_16_i_rgb_gen_busy_i_rgb_m_data_is_invalid_next = ~SobelFilter_gen_busy_r_4_16_gdiv;
    ...
    // (end of SobelFilter_gen_busy_r_4_16)
    ...
    always @(posedge i_clk)
      begin : drive_o_avg_m_unacked_req
        if (i_rst == 1'b0) 
          ...
          begin
            o_avg_m_unacked_req <= SobelFilter_And_1Ux1U_1U_4_14_out1;
          end
      end
    
    // resource: SobelFilter_And_1Ux1U_1U_4  instance: SobelFilter_And_1Ux1U_1U_4_14
    assign SobelFilter_And_1Ux1U_1U_4_14_out1 = o_avg_busy & o_avg_vld;
